//
//  CommentsHistoryTableViewCell.swift
//  Versus
//
...
class CommentsHistoryTableViewCell: UITableViewCell {
    ...
    func setCell(comment : VSComment, postInfo : PostInfo?){
        if postInfo != nil {
            redName.text = postInfo!.r
            blueName.text = postInfo!.b
        }
        else {
            redName.text = " "
            blueName.text = " "
